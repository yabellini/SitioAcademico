---
title: " Introducción al ABC para enseñar online | Introduction to online teaching essentials"
subtitle: ""
...
- icon: images
  icon_pack: fas
  name: slides v2.0
  url: https://docs.google.com/presentation/d/1pjeoDWU08ourgj_Y4LoU3gAUyGU5LRuycWhYOJ6_lt0/edit?usp=sharing
- icon: images
  icon_pack: fas
  name: slides v1.0
...
This was the first course conducted by [MetaDocencia](https://www.metadocencia.org/curso/intro-abc-online/).  There are two versions.  The first one used throughout 2020 and a second update during 2021.  You can find the materials for both versions on this website.
...
Este fue el primer curso realizado por MetaDocencia.  Hay dos versiones del mismo.  La primera utilizada durante todo el 2020 y una segunda actualización durante 2021.  Se pueden encontrar los materiales de ambas versiones en esta web.
